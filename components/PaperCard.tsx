  ...
  return (
    <article className="py-10">
      ...
      <div className="flex items-start gap-4 mb-2">
        <span className="text-[56px] font-black leading-none text-gray-100 font-serif-kr select-none flex-shrink-0">
          {String(index).padStart(2, "0")}
        </span>
        <div className="pt-1">
          <h2 className="text-xl font-bold font-serif-kr text-gray-900 leading-snug mb-1">
            {paper.title}
          </h2>
          <a
      ...
      <div className="flex gap-6 mt-4">
        {/* 왼쪽: 한국어 요약 */}
        <div className="flex-1 min-w-0 bg-gray-50 border-l-4 border-black px-5 py-4">
          {sections.length > 0 ? (
            sections.map((sec, i) => (
          ...
          <div className="w-64 flex-shrink-0 space-y-4">
            {paper.figures.map((fig, i) => (
              <div key={i}>
                ...
                />
                {fig.caption && (
                  <p className="text-[11px] text-gray-400 mt-1 italic leading-tight">
